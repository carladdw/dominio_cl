...
$content =
		...
		<br/><br/>
		'.estimado.':<br/>
		'.su_nueva_pass_es.': '.$npasswd.'
		<br/><br/>
		'.ingresar_desde_aqui.':<br/>
		<a href="'.$enlace.'" style="color:'.$fondo.'; font-weight:bold; text-decoration:underline;">'.$enlace.'</a>
		<br/><br/>
		'.recomienda_cambio_pass.'.
		</p>
		<p style="word-break:break-all;">
		<a href="'.$urlregistro.'" style="color:'.$fondo.'; font-weight:bold; text-decoration:underline;">'.$urlregistro.'</a>
		</p>
		</td>
		<td width="20"></td>
		</tr>
